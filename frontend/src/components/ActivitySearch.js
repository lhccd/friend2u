...
import { Button, Card , Row, Col, Form, Control } from 'react-bootstrap';
    ...
    render() {
      ...
      return (
        <div>
          ...
          <Form>
            <Form.Row>
              ...
              <Form.Group as={Col}>
                ...
                <Form.Control as="select" name="category" defaultValue="Other" onChange={this.handleChange}>
                  <option>Sport</option>
                ...
                <Form.Control type="text" name="activityName" placeholder="Search for activityname" value={this.state.value} onChange={this.handleChange}/>

                <Form.Label>From Time</Form.Label>
                <Form.Control type="datetime-local" name="fromTime" value={this.state.fromTime} min={cT} max={this.state.toTime} onChange={this.handleChange}/>

                <Form.Label>To Time</Form.Label>
                <Form.Control type="datetime-local" name="toTime" value={this.state.toTime} min={this.state.fromTime} onChange={this.handleChange}/>
                <br/>
                ...
                <Form.Control  type="number" name="minPrice" value={this.state.minPrice} min="1" max={this.state.maxPrice} onChange={this.handleChange}/>

                <Form.Label>Max Price</Form.Label>
                <Form.Control type="number" name="maxPrice" value={this.state.maxPrice} min={this.state.minPrice} max="5" onChange={this.handleChange}/>
                ...
                <div ref={this.sportRef} style={{ display: "none" }}>
                  ...
                  <Form.Control  type="number" name="minPhyCondition" value={this.state.minPhyCondition} min="1" max={this.state.maxPhyCondition} onChange={this.handleChange}/>

                  <Form.Label>Max physical condition</Form.Label>
                  <Form.Control type="number" name="maxPhyCondition" value={this.state.maxPhyCondition} min={this.state.minPhyCondition} max="4" onChange={this.handleChange}/>
                </div>

                <div ref={this.entertainmentRef} style={{ display: "none" }}>
                  <Form.Label>Title of the movie/concert/opera, which your desired activity should have</Form.Label>
          ...
          <Form.Control  type="number" name="minPhyCondition" value={this.state.maxDistance} min="1" max={500000} onChange={this.handleChange}/>
          <br/>
